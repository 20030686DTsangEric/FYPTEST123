...
class Appointment
{
    ...
    {
        $this->connect = new PDO("mysql:host=localhost;dbname=20220327teacherstudents", "root", "root");
    ...
    function get_total_today_appointment()
    {
		...
		WHERE teacher_schedule_date = CURDATE() 
		";
        $this->execute();
    ...
    function get_total_yesterday_appointment()
    {
		...
		INNER JOIN teacher_schedule_table 
		ON teacher_schedule_table.teacher_schedule_id = appointment_table.teacher_schedule_id 
		WHERE teacher_schedule_date = CURDATE() - 1
		";
        $this->execute();
        return $this->row_count();
    }
    ...
    function get_total_seven_day_appointment()
    {
		...
		INNER JOIN teacher_schedule_table 
		ON teacher_schedule_table.teacher_schedule_id = appointment_table.teacher_schedule_id 
		WHERE teacher_schedule_date >= DATE(NOW()) - INTERVAL 7 DAY
		";
        $this->execute();
        return $this->row_count();
    }
