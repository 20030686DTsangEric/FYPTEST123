        ...
        $(document).on('click', '.view_button', function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    html += '<tr><th width="40%" class="text-right">Student ID.</th><td width="60%">' + data.studentID + '</td></tr>';

                    html += '<tr><th width="40%" class="text-right">student_major</th><td width="60%">' + data.student_major + '</td></tr>';
                    ...
                    html += '<tr><th width="40%" class="text-right">Year of Student</th><td width="60%">' + data.student_year + '</td></tr>';
